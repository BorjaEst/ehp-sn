...
`openfield`, `dungeongen`, or `dagflow`.
...
For example, `openfield/v1` denotes the first OpenField semantic contract. It
...
| Family       | Specification                       | Classification                                                         | Status   |
| ------------ | ----------------------------------- | ---------------------------------------------------------------------- | -------- |
| `openfield`  | [`openfield/v1`](openfield-v1.md)   | Procedural spatial substrate                                           | Draft    |
| `dungeongen` | [`dungeongen/v1`](dungeongen-v1.md) | Procedural spatial substrate                                           | Draft    |
| `dagflow`    | [`dagflow/v1`](dagflow-v1.md)       | Procedural directed-graph substrate                                    | Draft    |
| `maze-nd`    | [`maze-nd/v1`](maze-nd-v1.md)       | Imported source-instance artifact; substrate classification unresolved | Proposed |
